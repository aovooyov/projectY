...
namespace Yandex.Direct.Configuration
{
    public class YandexDirectConfiguration : IYandexApiConfiguration
    {
        ...
        public YandexDirectConfiguration(string login, string certificatePath, string certificatePassword, YandexApiLanguage language)
        {
            AuthProvider = new FileCertificateAuthProvider(certificatePath, certificatePassword, login, null);
            ServiceUrl = new Uri("https://soap.direct.yandex.ru/json-api/v4/");
            Language = language;
        }
